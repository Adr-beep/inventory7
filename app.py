...
def panelUsuarios():
    if 'usuario' in session and session["role"]== "Superadministrador":
       ...
       #user_cant = len(cur.fetchall())
        ...
        return render_template('panelUsuarios.html', users = user_data, cant = len(user_data))
...
def panelProductos():
    if 'usuario' in session and session["role"]== "Superadministrador":
        ...
        return render_template('panelProductos.html', products = product_data,  cant = len(product_data))
    return redirect("/")
...
def panelProveedores():
    if 'usuario' in session and session["role"]== "Superadministrador":
        ...
        return render_template('panelProveedores.html', providers = provider_data,  cant = len(provider_data))
    return redirect("/")
...
def panelUsuariosAdmin():
    if 'usuario' in session and session["role"]== "Administrador":
        ...
        #Nueva variable para que traiga todo lo de la tabla
        user_data = cur.fetchall()
        return render_template('panelUsuariosAdministrador.html', users = user_data,  cant = len(user_data))
    return redirect("/")
...
def panelProductosAdmin():
    if 'usuario' in session and session["role"]== "Administrador":
        ...
        cur.execute("SELECT * FROM products")
        product_data = cur.fetchall()
        return render_template('panelProductosAdministrador.html', products = product_data,  cant = len(product_data))
    return redirect("/")
...
def panelProveedoresAdmin():
    if 'usuario' in session and session["role"]== "Administrador":
        ...
        cur.execute("SELECT * FROM providers")
        provider_data = cur.fetchall()
        return render_template('panelProveedoresAdministrador.html', providers = provider_data,  cant = len(provider_data))
    return redirect("/")
#--------------------------------------------------------------------------------------
...
def panelProductosusu():
    if 'usuario' in session and session["role"]== "Empleado":
        ...
        cur.execute("SELECT * FROM products")
        product_data = cur.fetchall()
        return render_template('panelProductosUsuario.html', products = product_data,  cant = len(product_data))
    return redirect("/")
...
def panelProveedoresusu():
    if 'usuario' in session and session["role"]== "Empleado":
        ...
        cur.execute("SELECT * FROM providers")
        provider_data = cur.fetchall()
        return render_template('panelProveedoresUsuario.html', providers = provider_data,  cant = len(provider_data))
    return redirect("/")
